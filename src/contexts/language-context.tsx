...
const translations: Record<Language, Record<string, string>> = {
  zh: {
    ...
    'home.tutorial.subtitle': '快速入门，掌握平台核心功能',
    'home.tutorial.button': '立即开始',
    'home.start': '开始体验',
    ...
    'mining.platform.title': '平台数据',
    'mining.platform.updateTime': '数据更新时间',
    'mining.user.title': '我的数据',
    'mining.leaderboard.title': '排行榜',
    'mining.leaderboard.description': '实时挖矿排行榜',
    ...
    // 登录页面
    'login.title': '登录账户',
    'login.subtitle': '欢迎回到NTX交易平台',
    'login.register.title': '注册账户',
    'login.register.subtitle': '创建您的NTX交易账户',
    'login.email.label': '邮箱地址',
    'login.email.placeholder': '请输入邮箱地址',
    'login.password.label': '密码',
    'login.password.placeholder': '请输入密码',
    'login.password.register.placeholder':
      '请输入密码（至少8位，包含字母和数字）',
    ...
    'login.verificationCode.label': '邮箱验证码',
    'login.verificationCode.placeholder': '请输入验证码',
    'login.inviteCode.label': '邀请码（可选）',
    'login.inviteCode.placeholder': '请输入邀请码（可选）',
    ...
    'login.and': '和',
    'login.error.emailRequired': '请先输入邮箱地址',
    'login.success.codesSent': '验证码已发送到您的邮箱',
    'login.error.sendCodeFailed': '发送验证码失败',
    'login.error.loginFailed': '登录失败，请重试',
    'login.error.registerFailed': '注册失败，请重试',
    'login.success.registerSuccess': '注册成功！请登录',
    // 表单验证错误
    'validation.email.invalid': '请输入有效的邮箱地址',
    'validation.password.required': '请输入密码',
    'validation.nickname.minLength': '昵称至少需要2个字符',
    'validation.nickname.maxLength': '昵称不能超过20个字符',
    'validation.verificationCode.length': '验证码为6位数字',
    'validation.password.minLength': '密码至少需要8个字符',
    'validation.password.maxLength': '密码不能超过128个字符',
    'validation.password.lowercase': '密码必须包含至少一个小写字母',
    'validation.password.number': '密码必须包含至少一个数字',
    'validation.password.uppercase': '密码必须包含至少一个大写字母',
    'validation.password.mismatch': '两次输入的密码不一致',
    'validation.terms.required': '请同意服务条款和隐私政策',
  ...
  en: {
    ...
    'login.subtitle': 'Welcome back to NTX Trading Platform',
    'login.register.title': 'Register Account',
    'login.register.subtitle': 'Create your NTX trading account',
    'login.email.label': 'Email Address',
    'login.email.placeholder': 'Please enter email address',
    'login.password.label': 'Password',
    'login.password.placeholder': 'Please enter password',
    'login.password.register.placeholder':
      'Please enter password (at least 8 characters, including letters and numbers)',
    'login.confirmPassword.label': 'Confirm Password',
    'login.confirmPassword.placeholder': 'Please enter password again',
    'login.nickname.label': 'Nickname',
    'login.nickname.placeholder': 'Please enter nickname',
    'login.verificationCode.label': 'Email Verification Code',
    'login.verificationCode.placeholder': 'Please enter verification code',
    'login.inviteCode.label': 'Invite Code (Optional)',
    'login.inviteCode.placeholder': 'Please enter invite code (optional)',
    'login.sendCode': 'Send Code',
    'login.resendCode': 'Resend',
    'login.loginButton': 'Login',
    'login.registerButton': 'Register',
    'login.switchToRegister': 'No account? Click to register',
    'login.switchToLogin': 'Already have an account? Click to login',
    'login.agreeTerms': 'I have read and agree to the',
    'login.termsOfService': 'Terms of Service',
    'login.privacyPolicy': 'Privacy Policy',
    'login.and': 'and',
    'login.error.emailRequired': 'Please enter email address first',
    'login.success.codesSent': 'Verification code has been sent to your email',
    'login.error.sendCodeFailed': 'Failed to send verification code',
    'login.error.loginFailed': 'Login failed, please try again',
    'login.error.registerFailed': 'Registration failed, please try again',
    'login.success.registerSuccess': 'Registration successful! Please login',
    // Form validation errors
    'validation.email.invalid': 'Please enter a valid email address',
    'validation.password.required': 'Please enter password',
    'validation.nickname.minLength': 'Nickname must be at least 2 characters',
    'validation.nickname.maxLength': 'Nickname cannot exceed 20 characters',
    'validation.verificationCode.length': 'Verification code must be 6 digits',
    'validation.password.minLength': 'Password must be at least 8 characters',
    'validation.password.maxLength': 'Password cannot exceed 128 characters',
    ...
    // Mining page
    'mining.platform.title': 'Platform Data',
    'mining.platform.updateTime': 'Data Update Time',
    'mining.user.title': 'My Data',
    'mining.leaderboard.title': 'Leaderboard',
    'mining.leaderboard.description': 'Real-time Mining Leaderboard',
