...
export function ProfilePage() {
  const stats = [
    { label: "总挖矿量", value: "12,345 NTX", icon: Award, color: "text-yellow-600" },
    { label: "总收益", value: "+$2,456", icon: TrendingUp, color: "text-green-600" },
      ...
      <div className="glass-card-strong px-6 pt-12 pb-8 rounded-b-3xl">
        <div className="flex items-center space-x-4">
          <Avatar className="w-20 h-20">
            ...
            <AvatarFallback className="glass-card text-slate-700 text-2xl font-bold">U</AvatarFallback>
          </Avatar>
          <div className="flex-1">
            <h2 className="text-slate-800 text-xl font-bold mb-1">用户123456</h2>
            <div className="flex items-center space-x-2 mb-2">
              <Badge className="bg-yellow-100/80 text-yellow-700 border-yellow-300">VIP会员</Badge>
              <Badge className="bg-slate-100/80 text-slate-700 border-slate-300">Lv.5</Badge>
            </div>
            <p className="text-slate-600 text-sm">加入时间：2024年1月</p>
          </div>
          <Button size="sm" className="glass-card text-slate-700 border-slate-300 bg-white/50">
            编辑
          </Button>
        </div>
      </div>
      ...
      <div className="px-6 -mt-4 space-y-6">
        ...
        <Card className="glass-card-strong border-yellow-200">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="gradient-text font-bold text-lg mb-1">VIP会员</h3>
            ...
            <Button className="w-full mt-4 diffused-button text-white font-semibold border-0">续费会员</Button>
          </CardContent>
        </Card>
        ...
        <Card className="glass-card border-white/30">
          <CardContent className="p-4">
            <Button variant="ghost" className="w-full text-red-500 hover:text-red-600 hover:bg-red-50/50">
